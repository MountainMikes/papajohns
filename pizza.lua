...
function onHover(g,e)
    ...
    TextLabel53654.Text = g.Frame.Rank.Text
    ...
    TextLabel7095612.Text = g.Frame.Village.Text
...
function addToPlayer(plr)
    spawn(function()
        ...
        TextLabel7.Text = "Player: "..(plr.Name) .. (game.Workspace.Livingthings:WaitForChild(plr.Name).Clan.Value)
        ...
        hover.Enabled = false
        local value = Instance.new("ObjectValue",hover)
